...
window.Wit = {
        ...
        SearchVehicleSeriesByVehicle: host + '/automobilemanage/vehicleSeries/searchVehicleSeriesByVehicle', //品牌车型的获取
        selectDealerAndTime: host + '/automobilemanage/maintenanceAppointment/selectDealerAndTime', //获取维保预约当天的时间段
        addMaintenanceAppointment: host + '/automobilemanage/maintenanceAppointment/addMaintenanceAppointment' //维保预约提交
    }
    //我的 部分
window.My = {
