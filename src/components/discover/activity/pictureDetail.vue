...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      getDetail: function () {
        var _this = this;
        this.$http.post(DISCOVERMESSAGE.pictureDetail, {"uid": _this.$store.state.userId,"id": _this.manageId}).then(function (res) {
          if (res.data.status) {
      ...
      giveShowPictureLike: function () {
        var _this = this;
        this.$http.post(DISCOVERMESSAGE.giveShowPictureLike, {"uid": _this.$store.state.userId,"lid": _this.manageId}).then(function (res) {
          if (res.data.status) {
      ...
      removeShowPictureLike: function () {
        var _this = this;
        this.$http.post(DISCOVERMESSAGE.removeShowPictureLike, {"uid": _this.$store.state.userId,"lid": _this.manageId}).then(function (res) {
          if (res.data.status) {
            _this.content.likeNum = res.data.data.num;
      ...
      getReadNum: function () {
        var _this = this;
        this.$http.post(DISCOVERMESSAGE.pictureRead, {"uid": _this.$store.state.userId,"lid": _this.manageId}).then(function (res) {
          if (res.data.status) {
      ...
      getComments: function () {
        var _this = this;
        this.$http.post(DISCOVERMESSAGE.showPictureCommentList, {"uid": _this.$store.state.userId,"lid": _this.manageId}).then(function (res) {
          if (res.data.status) {
      ...
      comment: function () {
        ...
        this.$http.post(DISCOVERMESSAGE.showPictureComment, {"uid": _this.$store.state.userId,"lid": _this.manageId,"message":_this.commentMsg,"id":concatId}).then(function (res) {
          if (res.data.status) {
            _this.fId = null;
            setTimeout(()=>{
              _this.getComments();
