...
export default {
  ...
  methods: {
    ...
    getaddress(){
         this.$http.post(Wit.Address,{ userNo:"UBS2018072410463590813"},this.$store.state.mytoken).then((res)=>{
      ...
      MessageBox.confirm("", {
        ...
        cancelButtonHighlight: true
          ...
          if (action == "confirm") {
              ...
              this.$http.post(Wit.RemoveAddress,{no:num},this.$store.state.mytoken).then((res)=>{
