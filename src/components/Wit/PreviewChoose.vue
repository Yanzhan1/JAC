...
export default {
  data() {
    return {
      ...
      carWheelCommonR17: "./static/images/Wit/R17common.png",
      carWheelCommonR18: "./static/images/Wit/R18common.png",
  ...
  methods: {
    confirmChooseBtn() {
      ...
      var outType =
        "外观：" + this.$store.state.outType + this.$store.state.colorTitle;
...
.contentCar .contentCarBtn .contentPic {
  flex: 1;
}
