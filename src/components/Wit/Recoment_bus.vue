    ...
    <div>
        ...
        <mt-popup v-model="popupVisible" position="middle">
            ...
            <ul class="flex row wrap ">
                <li class="flex row list_li cocenter" v-for="(item,index) in good_list" :key="index">
            ...
            <div style="width:100%;display:flex;text-align:center;padding:.3rem">
                <p style="felx:1;width:100%;font-size:.32rem;color:#888888;">取消</p>
                <p style="felx:1;width:100%;font-size:.32rem;color:#49BBFF;">确定</p>
            </div>
        </mt-popup>
    </div>
</template>
